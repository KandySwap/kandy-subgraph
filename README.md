# KandySwap V2 Subgraph

# This repository is archived, you can find all the PancakeSwawp subgraph at [kandyswap/kandy-subgraph](https://github.com/kandyswap/kandy-subgraph)

[KandySwap](https://kandyswap.com/) is a decentralized protocol for automated token exchange on Kucoin Community Chain.
...
Contains data across all of KandySwap v2. This entity tracks important things like total liquidity (in ETH and USD, see below), all time volume, transaction count, number of pairs and more.
