...
const USDC_WKCS_PAIR = '' // created block -
const DAI_WKCS_PAIR = ''  // created block -
const USDT_WKCS_PAIR = '' // created block -
...
export function getEthPriceInUSD(): BigDecimal {
  ...
  if (daiPair !== null && usdcPair !== null && usdtPair !== null) {
    let totalLiquidityKCS = daiPair.reserve1.plus(usdcPair.reserve0).plus(usdtPair.reserve1)
